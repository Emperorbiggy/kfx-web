      ...
      <div className="px-4 sm:px-6 mt-6 space-y-6 max-w-none">
        ...
        <div className="text-center py-8">
          ...
          <p className="text-gray-600 text-sm lg:text-base">
            Choose the option that works<br />
            best for you
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 lg:p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">Live support available</h3>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Quick answers to questions</p>
                  <div className="flex items-center space-x-4 mt-2">
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">Browse Help Topics</h3>
                  <p className="text-sm text-gray-600">Find answers in our knowledge base</p>
                  <div className="flex items-center space-x-4 mt-2">
