      ...
      <div className="px-4 sm:px-6 mt-6 space-y-6 max-w-none">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center mt-3 space-x-2">
                  <span className="flex items-center text-xs bg-secondary-green-100 text-secondary-green-800 px-3 py-1 rounded-full">
                    <FaCheckCircle className="w-3 h-3 mr-1" /> Verified
                  </span>
                  <span className="flex items-center text-xs bg-secondary-blue-100 text-secondary-blue-800 px-3 py-1 rounded-full">
                    Premium
                  </span>
                </div>
              </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-lg shadow-sm divide-y divide-secondary-grey-100">
            <div className="flex items-center justify-between p-4 lg:p-6 hover:bg-secondary-grey-50 transition-colors">
              <div className="flex items-center space-x-4">
                <div className="w-10 h-10 rounded-full bg-secondary-grey-100 flex items-center justify-center">
              ...
              <button
                ...
                className="text-secondary-blue-600 font-medium text-sm hover:text-secondary-blue-700 transition-colors px-4 py-2 rounded-lg hover:bg-secondary-blue-50"
              >
                Complete
              </button>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-sm divide-y divide-secondary-grey-100">
          {[
            ...
            },
            {
              ...
              description: "Get help with our comprehensive support center",
              onClick: () => router.push("/dashboard/profile/supports"),
            },
          ].map((section, index) => (
            <div
              key={index}
              className="flex items-center justify-between p-4 lg:p-6 hover:bg-secondary-grey-50 cursor-pointer transition-colors"
        ...
        <div className="bg-white rounded-lg shadow-sm">
          <button className="flex items-center justify-between w-full p-4 lg:p-6 text-secondary-red-600 font-medium hover:bg-secondary-red-50 transition-colors rounded-lg">
            <div className="flex items-center space-x-4">
              <div className="w-10 h-10 rounded-full bg-secondary-red-100 flex items-center justify-center">
        ...
        {/* Footer */}
        <div className="text-center text-sm text-secondary-grey-500 py-8 space-y-1">
